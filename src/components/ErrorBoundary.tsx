    ...
    if (this.state.hata) {
      return (
        <div style={{ minHeight: "100vh", background: "var(--color-cream)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
          <div className="card" style={{ maxWidth: 460, borderLeft: "4px solid var(--color-brick)" }}>
            <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--color-brick)", marginBottom: 8 }}>
              Görüntülenirken bir şeyler ters gitti
            </p>
            <p className="mono" style={{ fontSize: 13, color: "var(--color-gray)" }}>{this.state.hata}</p>
